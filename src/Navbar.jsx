      ...
      <a className="navbar-brand d-lg-none">
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <Nav.Link className="nav-link me-4 fw-normal fs-5" href="/courses">Courses</Nav.Link>
            ...
            />
            <Button variant="outline-success" className='fs-5 mb-4 me-2'>Search</Button>
          </Form>
          
            
          </Nav>
          <Nav.Link className="nav-link me-4 fw-normal fs-5 ms-3"  href="/contactus">Contact Us</Nav.Link>
